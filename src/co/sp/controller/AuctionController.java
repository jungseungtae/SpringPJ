...
public class AuctionController {
	...
	public String paymentwait_succee(@RequestParam(value = "content") int g_no) {
		...
		return "paymentwait_success";
	}

	@RequestMapping(value = "/auction_reply", produces = "application/text; charset=utf8")
	@ResponseBody
	public String auction_reply(@RequestParam(value = "r_no") int r_no,
			@RequestParam(value = "r_writer") String r_writer, @RequestParam(value = "r_text") String r_text) throws Exception {
