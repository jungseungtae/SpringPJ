...
public class UserController {
	...
	public String MyPage_edit_proc(@ModelAttribute("editUserBean") User editUserBean, HttpSession se, HttpServletRequest request) {
	...
	public String MyPage_delete_proc(@ModelAttribute("deleteUserBean") User deleteUserBean, HttpSession se, HttpServletRequest request) {
