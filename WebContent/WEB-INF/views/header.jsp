...
<script type="text/javascript">
	var socket = new WebSocket("ws://localhost:8080/MiniProjectJava/websocket");
	...
	<header>
		<div class="inner">
			<a href="${root }main" class="logo"><img
				src="${root }images/logo1.png" alt=""></a>
			<div class="sub-menu">
				<ul class="menu">
					<c:choose>
						<c:when test="${loginUserBean.u_id ne null }">
							<li><a href="javascript:void(0)">${loginUserBean.u_id }님</a></li>
