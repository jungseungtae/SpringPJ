				...
				<c:choose>
					<c:when test="${name eq 'offer'}">
						<c:choose>
							...
							<c:otherwise>
								<a href="${root }boardform1&page=${pageBean.prevPage-1}">Prev</a>
							</c:otherwise>
						</c:choose>
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="${root }boardform1&page=${pageBean.nextPage + 1}">Next</a>
							</c:otherwise>
						</c:choose>
					</c:when>
					...
					<c:when test="${name eq 'community'}">
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="${root }boardform2&page=${pageBean.nextPage + 1}">Next</a>
							</c:otherwise>
						</c:choose>
					</c:when>
				</c:choose>
