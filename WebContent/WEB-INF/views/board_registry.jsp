				...
				<c:choose>
					<c:when test="${name eq 'offer'}">
						<form:form modelAttribute="offerbean" action="board_registry_proc1" method="post">
							...
							<span>제목</span> <br><form:input placeholder="제목을 입력해주세요" class="text1" path="o_sub" required="true"/><br>
							<form:hidden path="o_regdate"/><br>
							<span>내용</span><br><form:textarea class="text3" path="o_text" placeholder="내용을 입력해주세요" required="true"/><br>
							<div class="btnbox">
					...
					<c:when test="${name eq 'community'}">
						<form:form modelAttribute="communitybean" action="board_registry_proc2" method="post">
							...
							<span>제목</span> <br><form:input placeholder="제목을 입력해주세요" class="text1" path="c_sub" required="true"/><br>
							<form:hidden path="c_regdate"/><br>
							<span>내용</span><br><form:textarea class="text3" path="c_text" placeholder="내용을 입력해주세요" required="true"/><br>
            				<div class="btnbox">
			                    <form:button type="submit" class="b1">작성완료</form:button>
