            	...
            	<c:choose>
	            	<c:when test="${loginUser ne null }">
		               <div class="swiper-slide">
		                  <img src="./images/slide01.jpg" alt="" onclick="location.href='auction_contents/20'"/>
		               </div>
		               <div class="swiper-slide">
		                  <img src="./images/slide02.jpg" alt="" onclick="location.href='auction_contents/18'"/>
		               </div>
		               <div class="swiper-slide">
		                  <img src="./images/slide03.jpg" alt="" onclick="location.href='auction_contents/19'"/>
		               </div>
		               <div class="swiper-slide">
		                  <img src="./images/slide04.jpg" alt="" onclick="location.href='auction_contents/17'"/>
		               </div>
	               </c:when>
	               <c:otherwise>
	               		<div class="swiper-slide">
         ...
         <section class="board">
            ...
            <c:choose>
               ...
               <c:otherwise>
               		<div class="title">
		               <div class="buy board-name" id="buybtn">
		                  <a href="function:void(0)">구매신청하기</a>
		               </div>
		               <div class="community board-name" id="communitybtn">
		                  <a href="function:void(0)">소통하기</a>
		               </div>
	               </div>
