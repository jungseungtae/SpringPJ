		...
		<div class="inner">
			<div class="content__form">
				<form:form action="auction_contents_registry_proc" modelAttribute="auctionContentBean" method="post">
					...
					<div class="sub">
						<span>제목</span><br>
						<form:input path="g_sub" placeholder="작품명을 입력해주세요" class="text1" required="true"/><br>
					</div>
					
					<div class="img">
						<span>작품사진</span><br>
						<form:input value="${img }" class="text1" path="g_img" placeholder="작품의 이미지주소를 입력해주세요." required="true"/><br>
					</div>
					
					<div class="text">
						<span>내용</span><br>
						<form:textarea class="text2" path="g_text" placeholder="작품을 설명해주세요." required="true"/><br>
					</div>
					
					<div class="stime">
						<span>경매시간</span><br>
						<form:input type="datetime-local" path="g_stime" class="text3" required="true"/><br>
					</div>
